...
const projects = [
	{
		...
		description:
			'Modern portfolio template with glassmorphism design, dark/light mode, and smooth animations.',
	...
	},
	{
		...
		description:
			'Intelligent code completion and optimization tool powered by machine learning algorithms.',
		image: '/api/placeholder/400/250',
	...
	},
	{
		...
		description:
			'Real-time analytics dashboard for cloud infrastructure monitoring with beautiful visualizations.',
		image: '/api/placeholder/400/250',
	...
	},
	{
		...
		description:
			'Automated cryptocurrency trading bot with advanced technical analysis and risk management.',
		image: '/api/placeholder/400/250',
	...
	},
	{
		...
		description:
			'Cross-platform mobile app for task management with offline sync and team collaboration.',
		image: '/api/placeholder/400/250',
	...
	},
	{
		...
		description:
			'Complete CI/CD pipeline setup with automated testing, deployment, and monitoring.',
		image: '/api/placeholder/400/250',
			...
			<div className="container mx-auto">
				...
				<div className="text-center mb-16">
					...
					<p className="text-xl text-muted-foreground max-w-2xl mx-auto font-mono">
						<span className="text-terminal-green">//</span> Showcasing my latest work
						and side projects
					</p>
				</div>
